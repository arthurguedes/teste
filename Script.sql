...
SET ANSI_PADDING ON
GO
IF EXISTS(SELECT 1 FROM sys.tables WHERE name = 'Address') DROP TABLE [dbo].[Address]
...
SET ANSI_PADDING ON
GO
IF EXISTS(SELECT 1 FROM sys.tables WHERE name = 'Order') DROP TABLE [dbo].[Order]
...
SET ANSI_PADDING ON
GO
IF EXISTS(SELECT 1 FROM sys.tables WHERE name = 'User') DROP TABLE [dbo].[User]
